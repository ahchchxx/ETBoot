...
import com.etboot.common.constant.SettingConstant;
import com.etboot.common.exception.XbootException;
import com.etboot.common.utils.*;
import com.etboot.common.vo.EmailValidate;
...
import com.etboot.modules.base.vo.OtherSetting;
...
public class EmailValidateController {
    ...
    public Result<Object> sendEditCode(@PathVariable String email, HttpServletRequest request) {
    ...
    public Result<Object> sendResetCode(@PathVariable String email, HttpServletRequest request) {
    ...
    public Result<Object> sendEmailCode(String email, String operation, String title, String template, HttpServletRequest request) {
        ...
        emailValidate.setOperation(operation);
        ...
        if ("修改邮箱".equals(operation)) {
            ...
            emailValidate.setUsername(u.getUsername());
        ...
        emailValidate.setCode(code);
        emailValidate.setEmail(email);
        emailValidate.setFullUrl(getOtherSetting().getDomain());
        redisTemplate.opsForValue().set(CommonConstant.PRE_EMAIL + email, new Gson().toJson(emailValidate, EmailValidate.class),
                10L, TimeUnit.MINUTES);

        // ★
        emailUtil.sendTemplateEmail(email, title, template, emailValidate);
    ...
    public Result<Object> resetByEmail(@RequestParam String email,
        ...
        // verify code with the cache in redis.     △ this part is in EmailValidateFilter
        // String redisInfo = redisTemplate.opsForValue().get(CommonConstant.PRE_EMAIL + email);
        // if (StringUtils.isEmpty(redisInfo)) {
        //     return ResultUtil.error("code expired");
        // }
        // EmailValidate emailValidate = new Gson().fromJson(redisInfo, EmailValidate.class);
        // if (emailValidate == null || emailValidate.getCode() == null || !emailValidate.getCode().equals(code)){
        //     return ResultUtil.error("code not match");
        // }
