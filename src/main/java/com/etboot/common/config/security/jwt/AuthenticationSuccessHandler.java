...
import com.etboot.common.utils.IpInfoUtil;
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if (tokenProperties.getRedis()) {
            ...
            if (saved) {
                ...
                // redisTemplate.set(SecurityConstant.TOKEN_PRE + token, JSON.toJSONString(user), tokenProperties.getSaveLoginTime(), TimeUnit.DAYS);
            } else {
                ...
                // redisTemplate.set(SecurityConstant.TOKEN_PRE + token, JSON.toJSONString(user), tokenProperties.getTokenExpireTime(), TimeUnit.MINUTES);
            }
        } else {
            // JWT不缓存权限 避免JWT长度过长
            list = null;
